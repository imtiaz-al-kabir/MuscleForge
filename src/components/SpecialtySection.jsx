...
const SpecialtySection = () => {
  return (
    <div
      className="
        relative w-full flex justify-center px-4 mt-[-40px] mb-10 z-30
        lg:absolute lg:mt-0 lg:mb-0 lg:px-0 lg:justify-start
        lg:top-[28%] lg:left-0
        xl:top-[35%] xl:left-[-4px]
        2xl:top-[35%]
      "
    >
      <div className="relative w-full max-w-[320px] sm:max-w-[360px] lg:max-w-[280px] xl:max-w-[300px] min-h-[480px] lg:min-h-[500px] p-6 md:p-8 pb-10 flex flex-col justify-center">
        {/* Background Image */}
        <div className="absolute inset-0 z-0 drop-shadow-2xl overflow-hidden rounded-[30px] lg:rounded-none">
          <img
            src={vectorBg}
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-white font-heading font-black text-[24px] uppercase tracking-[0.2em] mt-32 md:mt-35 mb-6 md:mb-8 w-full leading-tight pl-2 drop-shadow-lg">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white/5 hover:bg-white/20 h-[60px] md:h-[80px] transition-all duration-300 border border-white/20 rounded-[20px] p-1 flex items-center gap-2 cursor-pointer group backdrop-blur-md shadow-lg 
            rounded-b-[50px] 
